...
# ---- Configurable paths ----
ENV_PATH=~/venv/nerfstudio/bin/activate
DATA_ROOT="${1:-/media/home/zxguo/thin-obj-data-setup/data/data_collection_COLMAP}"   # root containing scene folders
OUTPUT_ROOT="${2:-/media/home/zxguo/thin-obj-data-setup/data/depth_nerfacto_output_with_eval}" # root output folder
