...
# ---- Configurable paths ----
ENV_PATH=~/venv/gaussian_splatting/bin/activate
DATA_ROOT="${1:-/media/home/zxguo/thin-obj-data-setup/data/data_collection_GS}"   # root containing scene folders
OUTPUT_ROOT="${2:-/media/home/zxguo/thin-obj-data-setup/data/gaussian_3d_output_with_eval}" # root output folder
...
# Run settings
MODEL_NAME="gaussian_splatting_3d"
