...
class DepthHead(nn.Module):
    ...
    def forward(
        ...
        # print(type(rays_embedding_16))
        # print(rays_embedding_16.shape)
...
class Decoder(nn.Module):
    ...
    def forward(self, inputs, image_metas) -> torch.Tensor:
        ...
        # print(f"Batch size: {B}, Height: {H}, Width: {W}, Device: {device}")

        # make stride happy?
        original_encoder_outputs = [x.contiguous() for x in inputs["encoder_outputs"]]
        cls_tokens = [x.contiguous() for x in inputs["cls_tokens"]]
        # print(f"Original encoder outputs: {len(original_encoder_outputs)}")
        # print(f"CLS tokens: {len(cls_tokens)}")
        ...
        # print(f"Processed encoder outputs: {len(original_encoder_outputs)}")
        # print(f"Processed CLS tokens: {len(cls_tokens)}")
        ...
        # print(f"Common shapes: {common_shape}")
        ...
        # print(f"Features flat: {len(features_flat)}")
        # print(f"Features splits: {features_splits}")
        ...
        # print(f"Level embed shape: {level_embed.shape}")
        ...
        # Print the shapes of intrinsics and rays
