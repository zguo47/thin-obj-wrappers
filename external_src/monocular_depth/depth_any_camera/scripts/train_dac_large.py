...
Training large transformer model involves a different scheduler with a warmup period. Other parts are identical to the basic version.
"""
...
from dac.optimization.scheduler import CosineScheduler
from dac.utils.ema_torch import (DummyExponentialMovingAverage,
