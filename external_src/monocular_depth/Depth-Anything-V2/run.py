...
if __name__ == '__main__':
    ...
    for k, (filename, lidar_filename) in enumerate(zip(filenames, lidar_filenames)):
        ...
        #save_dir = lidar_filename.replace('lidar', 'depthanythingv2_518').replace('png', 'npy')
        save_dir = lidar_filename.replace('lidar', 'depthanythingv2_518_patrick').replace('png', 'npy')
        # pdb.set_trace()
